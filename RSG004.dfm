object fDetDesplaz: TfDetDesplaz
  Left = 326
  Top = 87
  BorderStyle = bsDialog
  Caption = 'Detalle de Desplazamiento x Departamento'
  ClientHeight = 576
  ClientWidth = 552
  Color = clBtnFace
  ...
  object dtgCabDes: TwwDBGrid
    ...
    TitleLines = 2
    TitleButtons = False
    OnDrawDataCell = dtgCabDesDrawDataCell
    OnDblClick = dtgCabDesDblClick
    IndicatorIconColor = 10930928
